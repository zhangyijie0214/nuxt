module.exports = {
    ...
    rules: {
        ...
        'object-curly-spacing': ['warn', 'always'], // 在大括号内强制执行一致的间距
        ...
        'key-spacing': ['error', { beforeColon: false, afterColon: true, mode: 'strict' }], // @fixable 对象字面量中冒号前面禁止有空格，后面必须有空格
    }
}